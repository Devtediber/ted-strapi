"use strict";(self.webpackChunkted_strapi=self.webpackChunkted_strapi||[]).push([[3033],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(42638),p=s(94061),V=s(48653),E=s(83997),S=s(30893);const F=(0,_.Ay)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
